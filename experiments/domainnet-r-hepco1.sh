...
DATE=hepco_v6.0_DOMAINNET_iid_cutoff_cutratio_0.4_seed_1_new_withmse_3minmax
...
python -u run.py --config $CONFIG_CLIP_P --gpuid $GPUID --repeat $REPEAT --memory $MEMORY --overwrite $OVERWRITE --debug_mode $DEBUG \
    ...
    --log_dir ${OUTDIR}/vit/l2p_multi-layer --overwrite 1 --seed 1 --lambda_mse 1 --minmax_epochs 3
