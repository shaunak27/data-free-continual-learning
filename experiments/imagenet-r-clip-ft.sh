...
# save directory
DATE=centralizedclipl2p_multilayer_5task_onlyprompt
...
CONFIG_CLIP_FT=configs/imnet-r_clip_ft.yaml
REPEAT=1
MEMORY=0
OVERWRITE=0
DEBUG=0
...
python -u run.py --config $CONFIG_CLIP_FT --gpuid $GPUID --repeat $REPEAT --memory $MEMORY --overwrite $OVERWRITE --debug_mode $DEBUG \
