...
# DATE=fedavg_v6.0_INR_iid_cutoff_cutratio_0.4_seed_1
...
# DATE=fedavg_v6.0_INR_iid_cutoff_cutratio_0.4_seed_2
# OUTDIR=_outputs/${DATE}/${DATASET}/${SPLIT}-task
# mkdir -p $OUTDIR
# python -u run.py --config $CONFIG_CLIP_P --gpuid $GPUID --repeat $REPEAT --memory $MEMORY --overwrite $OVERWRITE --debug_mode $DEBUG \
#     --learner_type prompt --learner_name L2P \
...
DATE=fedavg_v6.0_INR_iid_cutoff_cutratio_0.4_seed_0
OUTDIR=_outputs/${DATE}/${DATASET}/${SPLIT}-task
mkdir -p $OUTDIR
python -u run.py --config $CONFIG_CLIP_P --gpuid $GPUID --repeat $REPEAT --memory $MEMORY --overwrite $OVERWRITE --debug_mode $DEBUG \
    --learner_type prompt --learner_name L2P \
