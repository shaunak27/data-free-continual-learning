# sh experiments/ICCV/cifar100-twentytask.sh n
...
# save directory
DATE=ICCV-shuffled
OUTDIR=outputs/${DATE}/coreset-free-replay-twentytask/CIFAR100
...
#         --mu $MU  --memory $MEMORY --model_name $MODELNAME  --model_type resnet \
#         --learner_type dgr --learner_name Generative_Replay --KD \
#         --gen_model_name $GENMODELNAME --gen_model_type autoencoder \
#         --vis_flag $vis_flag --overwrite $OVERWRITE --debug_mode $DEBUG --max_task $MAXTASK --log_dir ${OUTDIR}/dgr
