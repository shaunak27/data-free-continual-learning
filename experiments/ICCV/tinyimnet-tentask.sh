# sh experiments/ICCV/tinyimnet-tentask.sh n
...
# save directory
DATE=ICCV-shuffled
OUTDIR=outputs/${DATE}/coreset-free-replay-tentask/TinyImageNet
...
then
    ...
    python -u run_ucl.py --dataset TinyImageNet --train_aug --rand_split --gpuid $GPUID --repeat $REPEAT --dataroot $DATAROOT\
        ...
        --memory 0   --model_name $MODELNAME  --model_type $MODELTYPE \
    ...
    python -u run_ucl.py --dataset TinyImageNet --train_aug --rand_split --gpuid $GPUID --repeat $REPEAT --dataroot $DATAROOT\
        --first_split_size $SPLIT --other_split_size $SPLIT  --schedule $SCHEDULE --schedule_type decay --batch_size $BS    \
        --optimizer $OPT --lr $LR --momentum $MOM --weight_decay $WD \
        --memory 2000  --model_name $MODELNAME  --model_type $MODELTYPE \
        --learner_type default --learner_name NormalNN \
...
then
    ...
    python -u run_ucl.py --dataset TinyImageNet --train_aug --rand_split --gpuid $GPUID --repeat $REPEAT --dataroot $DATAROOT\
        --first_split_size $SPLIT --other_split_size $SPLIT  --schedule $SCHEDULE --schedule_type decay --batch_size $BS    \
        --optimizer $OPT --lr $LR --momentum $MOM --weight_decay $WD \
        --mu $MU --memory 0  --model_name $MODELNAME  --model_type $MODELTYPE --KD \
    ...
    python -u run_ucl.py --dataset TinyImageNet --train_aug --rand_split --gpuid $GPUID --repeat $REPEAT --dataroot $DATAROOT\
        --first_split_size $SPLIT --other_split_size $SPLIT  --schedule $SCHEDULE --schedule_type decay --batch_size $BS    \
        --optimizer $OPT --lr $LR --momentum $MOM --weight_decay $WD \
        --mu $MU --memory 2000  --model_name $MODELNAME  --model_type $MODELTYPE --KD \
        --learner_type kd --learner_name LWF \
    ...
    python -u run_ucl.py --dataset TinyImageNet --train_aug --rand_split --gpuid $GPUID --repeat $REPEAT --dataroot $DATAROOT\
        --first_split_size $SPLIT --other_split_size $SPLIT  --schedule $SCHEDULE --schedule_type decay --batch_size $BS    \
        --optimizer $OPT --lr $LR --momentum $MOM --weight_decay $WD \
        --mu $MUStar --memory $MEMORY --model_name $MODELNAME  --model_type $MODELTYPE \
...
then
    ...
    python -u run_ucl.py --dataset TinyImageNet --train_aug --rand_split --gpuid $GPUID --repeat $REPEAT --dataroot $DATAROOT\
        --first_split_size $SPLIT --other_split_size $SPLIT  --schedule $SCHEDULE --schedule_type decay --batch_size $BS    \
        --optimizer $OPT --lr $LR --momentum $MOM --weight_decay $WD \
        --mu $MU --memory $MEMORY --model_name $MODELNAME  --model_type $MODELTYPE \
