...
DATE=hepco_v6.0_INR_iid_cutoff_cutratio_0.4_seed_1_percent_0.3
...
python -u run.py --config $CONFIG_CLIP_P --gpuid $GPUID --repeat $REPEAT --memory $MEMORY --overwrite $OVERWRITE --debug_mode $DEBUG \
    ...
    --prompt_param 100 20 1 -1 --kl --hepco --imbalance 1 --percent 0.3 --n_clients 5 --n_rounds 10 --cutoff --lambda_KL 1 --cutoff_ratio 0.4 --replay_ratio 0.5 \
