...
DATE=fedprox_v6.0_DOMAINNET_iid_cutoff_cutratio_0.4_seed_27_mu_0.1
...
python -u run.py --config $CONFIG_CLIP_P --gpuid $GPUID --repeat $REPEAT --memory $MEMORY --overwrite $OVERWRITE --debug_mode $DEBUG \
    ...
    --log_dir ${OUTDIR}/vit/l2p_multi-layer --overwrite 1 --seed 27 --loss_type fedprox --lambda_prox 0.1
