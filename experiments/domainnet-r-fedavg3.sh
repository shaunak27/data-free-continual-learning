...
# hard coded inputs
GPUID='0 1'
CONFIG_CLIP_P=configs/domainnet_vit.yaml
REPEAT=1
MEMORY=0
OVERWRITE=0
DEBUG=0
...
DATE=fedavg_v5.0_DOMAINNET_iid_centralized_20epochs_seed_1_1e-3_new
...
# DATE=fedavg_v5.0_DOMAINNET_iid_cutoff_cutratio_0.4_seed_3
# OUTDIR=_outputs/${DATE}/${DATASET}/${SPLIT}-task
# mkdir -p $OUTDIR
# python -u run.py --config $CONFIG_CLIP_P --gpuid $GPUID --repeat $REPEAT --memory $MEMORY --overwrite $OVERWRITE --debug_mode $DEBUG \
#     --learner_type prompt --learner_name L2P \
