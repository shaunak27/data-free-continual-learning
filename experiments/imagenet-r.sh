...
CONFIG_CLIP_FED=configs/imnet-r_clip_prompt_fed.yaml
REPEAT=1
MEMORY=0
OVERWRITE=0
DEBUG=0
...
python -u run.py --config $CONFIG_CLIP_FED --gpuid $GPUID --repeat $REPEAT --memory $MEMORY --overwrite $OVERWRITE --debug_mode $DEBUG \
     --learner_type prompt --learner_name L2P --log_dir ${OUTDIR}/fednn --prompt_param 100 20 1 -1 --mu $MU
