""" MHA implementation for prompting"""
...
def _scaled_dot_product_attention(
    ...
    #print(k.shape,v.shape) #[640,77,64]
...
def multi_head_attention_forward(
    ...
    if vflag: 
        pass #print(query.shape,key.shape) [50,batch_size_from_config,768]
    ...
    if prompt is not None:
        pk, pv = prompt
        pk = pk.permute(1,0,2).reshape(pk.shape[1],bsz*num_heads,-1).transpose(0,1)
